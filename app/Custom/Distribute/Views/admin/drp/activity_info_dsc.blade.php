    ...
    <div class="content_tips">
        <div class="tabs_info">
            <ul>
                ...
                <li class="curr"><a href="{{ route('distribute.admin.activity_info_sanmu',array('id'=>$activity_detail['id'] ?? 0))  }}">{{$lang['act_sanmu_info']}}</a></li>
            </ul>
        </div>
        ...
        <div>{{$activity_sanmu}}</div>
    </div>
</div>
<script>
    var ue = UE.getEditor('act_sanmu');
</script>
