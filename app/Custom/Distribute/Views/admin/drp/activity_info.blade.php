...
{{--                <li><a href="{{ route('distribute.admin.activity_info_sanmu',array('id'=>$activity_detail['id'] ?? 0))  }}">{{$lang['act_sanmu_info']}}</a></li>--}}
            </ul>
        </div>
        ...
        <div class="main-info">
            ...
            <div class="switch_info" style="overflow:inherit;">
                ...
                <div class="item">
                    <div class="label-t">{{$lang['require_field']}}{{$lang['act_sanmu']}}</div>
                    <div class="label_value">
                        <textarea name="data[act_sanmu]" id="text_info" class="textarea" cols="80" rows="5">{{$activity_detail['act_sanmu'] ?? ''}}</textarea>
                    </div>
                </div>
