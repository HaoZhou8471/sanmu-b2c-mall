...
class HomeindexController extends InitController
{
    ...
    public function index()
    {
        ...
        $real_ip = $this->sanmuRepository->sanmuIp();
        ...
        if (!$GLOBALS['smarty']->is_cached('homeindex.dwt', $cache_id) || $this->preview == 1) {
            ...
            $GLOBALS['smarty']->assign('child_cat', $this->indexManageService->get_child_cat($GLOBALS['smarty']->_var['goods_cat']['id'], 3)));             
            ...
            $topBanner = str_replace($replace_data, $GLOBALS['sanmu']->url(), $topBanner);
            $page = str_replace($replace_data, $GLOBALS['sanmu']->url(), $page);
