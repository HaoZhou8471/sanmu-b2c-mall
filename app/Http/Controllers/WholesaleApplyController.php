    ...
    public function index()
    {
        ...
        if ($act == 'index') {
            ...
            if (request()->isMethod('post')) {
                ...
                $front_of_id_card_path = $this->sanmuRepository->editUploadImage($front_of_id_card_path);
                $reverse_of_id_card_path = $this->sanmuRepository->editUploadImage($reverse_of_id_card_path);
                $suppliers_logo_path = $this->sanmuRepository->editUploadImage($suppliers_logo_path);
