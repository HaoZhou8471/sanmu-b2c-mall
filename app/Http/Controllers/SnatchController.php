    ...
    public function index()
    {
        ...
        if ($act == 'buy') {
            ...
            if (empty($snatchInfo['is_end'])) {
                $page = $this->sanmuRepository->buildUri('snatch', ['sid' => $id]);
                return sanmu_header("Location: $page\n");
            }
            ...
            /* 进入收货人页面 */
            return sanmu_header("Location: ./flow.php?step=checkout&direct_shopping=3\n");
        }
    }
}
