...
class AjaxFlowController extends InitController
{
    ...
    public function index()
    {
        ...
        /* 载入语言文件 */
        $this->sanmuRepository->helpersLang(['flow', 'user', 'shopping_flow']);
            ...
            if (empty($goods->spec) and empty($goods->quick)) {
                ...
                if (!empty($res)) {
                    ...
                    foreach ($res as $row) {
                        ...
                        $row['img_site'] = !empty($attr_info['attr_site']) ? $this->sanmuRepository->getImagePath($attr_info['attr_site']) : '';
                        ...
                        $spe_arr[$row['attr_id']]['values'][] = [
                            ...
                            'format_price' => $this->sanmuRepository->getPriceFormat($row['attr_price'], false),
