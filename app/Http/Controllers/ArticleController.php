...
class ArticleController extends InitController
{
    ...
    public function index()
    {
        ...
        /* 跳转H5 start */
        $Loaction = sanmu_url('/#/articleDetail/' . $article_id);
        ...
        if (!empty($article['link']) && $article['link'] != 'http://' && $article['link'] != 'https://') {
            return sanmu_header("location:$article[link]\n");
        }
        ...
        if (!empty($next_article)) {
            $next_article['url'] = $this->sanmuRepository->buildUri('article', ['aid' => $next_article['article_id']], $next_article['title']);
        ...
        if (!empty($prev_article)) {
            ...
            $prev_article['url'] = $prev_article ? $this->sanmuRepository->buildUri('article', ['aid' => $prev_article['article_id']], $prev_article['title']) : '';
