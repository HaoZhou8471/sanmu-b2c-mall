...
class UserWholesaleController extends InitController
{
    ...
    public function index()
    {
        ...
        if ($action == 'wholesale_purchase') {
            ...
            $this->sanmuRepository->helpersLang('wholesale_purchase');
        ...
        elseif ($action == 'wholesale_buy') {
            ...
            $this->sanmuRepository->helpersLang('wholesale');
        ...
        elseif ($action == 'wholesale_affirm_received') {
            ...
            if ($received) {
                return sanmu_header("Location: user_wholesale.php?act=wholesale_buy\n");
            } else {
        ...
        elseif ($action == 'wholesale_cancel_return') {
            ...
            if ($cancel_return) {
                return sanmu_header("Location: user_wholesale.php?act=wholesale_return_list\n");
            } else {
        ...
        elseif ($action == 'wholesale_return_detail') {
            ...
            foreach ($shipping_list as $key => $val) {
                ...
                $shipping_fee = $this->sanmuRepository->shippingFee($val['shipping_code'], unserialize($val['configure']));
        ...
        elseif ($action == 'wholesale_apply_return') {
            ...
            /* 退货权限 by wu */
            $sql = " SELECT order_id FROM " . $GLOBALS['sanmu']->table('wholesale_order_info') . " WHERE order_id = '$order_id' AND shipping_status > 0 ";
