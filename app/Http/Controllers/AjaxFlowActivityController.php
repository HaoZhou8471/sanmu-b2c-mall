    ...
    public function index()
    {
        ...
        if ($step == 'show_gift_div') {
            ...
            foreach ($activity['gift'] as $key => $row) {
                ...
                $activity['act_gift_list'][$key]['url'] = $this->sanmuRepository->buildUri('goods', ['gid' => $row['id']], $row['name']);
            }
        ...
        elseif ($step == 'add_package_to_cart') {
            ...
            $package = sanmu_decode($package_info);
        ...
        elseif ($step == 'validate_value_card') {
            ...
            $tmp_shipping_id_arr = sanmu_decode($shipping_id, true);
