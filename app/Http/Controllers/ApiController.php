...
class ApiController extends InitController
{
    ...
    {
        require(plugin_path('Sanmuapi/autoload.php'));

        /* 初始化基础类 */
        $base = new \App\Plugins\Sanmuapi\app\func\base();
        ...
        if ($format == "json" && $data) {
            ...
            $data = sanmu_decode(json_encode(simplexml_load_string($data, 'SimpleXMLElement', LIBXML_NOCDATA)), true);
        }
        ...
        $interface = $base->get_interface_file(plugin_path('Sanmuapi'), $interface);
        ...
        require(plugin_path('Sanmuapi/view/' . $file_type . '.php'));
    }
}
