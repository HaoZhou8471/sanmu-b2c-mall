...
class AuctionController extends InitController
{
    ...
    public function index()
    {
        ...
        elseif ($act == 'view') {
            ...
            /* 跳转H5 start */
            $Loaction = sanmu_url('/#/auction/detail/' . $id);
            $uachar = $this->sanmuRepository->getReturnMobile($Loaction);
            ...
            $content = cache()->remember('auction.dwt.' . $cache_id, $this->config['cache_time'], function () use ($auctionInfo, $id, $user_id, $warehouse_id, $area_id, $area_city) {
                ...
                $goodsInfo['url'] = $this->sanmuRepository->buildUri('goods', ['gid' => $auctionInfo['goods_id']], $goodsInfo['goods_name']);
        ...
        elseif ($act == 'bid') {
            ...
            /* 跳转到活动详情页 */
            return sanmu_header("Location: auction.php?act=view&id=$id\n");
        }
        ...
        elseif ($act == 'buy') {
            ...
            /* 进入收货人页面 */
            return sanmu_header("Location: ./flow.php?step=checkout&direct_shopping=2\n");
        }
    }
}
