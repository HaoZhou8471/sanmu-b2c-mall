...
class Installer
{
    ...
    public function get_system_info()
    {
        ...
        $file_types = array(
            'dwt' => resource_path('views/themes/ecmoban_sanmu2017/index.dwt'),
            'lbi' => resource_path('views/themes/ecmoban_sanmu2017/library/member_info.lbi'),
    ...
    public function install_data($sql_files, $db_host, $db_port, $db_user, $db_pass, $db_name)
    {
        ...
        $this->sqlExecutor->sprefix = 'sanmu_';
    ...
    public function get_spt_code()
    {
        ...
        $spt .= "url=" . urlencode($GLOBALS['sanmu']->url()) . "&mod=install&version=" . VERSION . "&hash_code=" . $hash_code . "&charset=" . EC_CHARSET . "&language=" . $GLOBALS['installer_lang'] . "\"></script>";
