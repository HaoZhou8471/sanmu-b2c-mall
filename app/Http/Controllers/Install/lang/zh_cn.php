...
/* 欢迎页 */
$_LANG['welcome_title'] = '欢迎您选用三目X网上商店管理系统！';
...
/* 环境检测页 */
$_LANG['checking_title'] = '三目X安装程序 第2步/共3步 环境检测';
...
/* 系统设置 */
$_LANG['setup'] = '填写完毕';
$_LANG['setting_title'] = '三目X安装程序 第3步/共3步 配置系统';
...
/* 提示信息 */
$_LANG['has_locked_installer'] = '<a style="text-decoration:none; font-size:14px;">安装程序已经被锁定。</a><br /><a style="text-decoration:none; font-size:14px;">如果您确定要重新安装 <font style="color:#ec5150;">三目X</font>，请删除data目录下的 <font style="color:#ec5150;">install.lock.php</font>。</a>';
...
$_LANG['install_done_title'] = '三目X 安装程序 安装成功';
$_LANG['install_error_title'] = '三目X 安装程序 安装失败';
$_LANG['done'] = '基于安全的考虑，请在安装完成后删除 <em>install</em> 目录。';
$_LANG['go_to_view_my_sc'] = '前往 三目X 首页';
$_LANG['go_to_view_control_panel'] = '前往 三目X 后台管理中心';
