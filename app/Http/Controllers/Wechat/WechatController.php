                        ...
                        if (!empty($mediaInfo['article_id'])) {
                            ...
                            foreach ($article_ids as $key => $val) {
                                ...
                                $replyData[$key] = [
                                    ...
                                    'url' => empty($artinfo['link']) ? sanmu_url('/#/wechatMedia', ['id' => $artinfo['id']]) : strip_tags(html_out($artinfo['link'])),
                            ...
                            $replyData[] = [
                                ...
                                'url' => empty($mediaInfo['link']) ? sanmu_url('sanmu_url/#/wechatMedia', ['id' => $mediaInfo['id']]) : strip_tags(html_out($mediaInfo['link'])),
