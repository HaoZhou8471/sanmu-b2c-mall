...
class AjaxDialogController extends InitController
{
    ...
    public function index()
    {
        ...
        elseif ($act == 'gotoInvoice') {
            ...
            $tmp_shipping_id_arr = sanmu_decode($shipping_id);
        ...
        elseif ($act == 'user_inv_gotopage') {
            ...
            if (count($id) > 1) {
                ...
                $id = explode("|", $id[1]);
                $order = $this->sanmuRepository->getStrArray1($id);
        ...
        elseif ($act == 'store_shop_gotoPage') {
            ...
            //引入相关语言包
            $this->sanmuRepository->helpersLang('search');
            ...
            if ($id) {
                $id = explode("|", $id);
                $id = $this->sanmuRepository->getStrArray2($id);
        ...
        elseif ($act == 'flow_shipping') {
            ...
            if ($rec_id) {
                $rec_id = $this->sanmuRepository->delStrComma($rec_id);
                $cart_value = $this->sanmuRepository->delStrComma($cart_value);
        ...
        elseif ($act == 'del_hometemplates') {
            ...
            sanmu_unlink(storage_public('data/sc_file/hometemplates/' . $code . ".php"));
        }
        ...
        elseif ($act == 'del_topictemplates') {
            ...
            sanmu_unlink(storage_public('data/sc_file/topic/topic_' . $seller_id . "/" . $code . ".php"));
        }
        ...
        elseif ($act == 'del_sellertemplates') {
            ...
            sanmu_unlink(storage_public('data/sc_file/sellertemplates/seller_tem_' . $seller_id . "/" . $code . ".php"));
        }
