...
class GroupBuyController extends InitController
{
    ...
    public function index()
    {
        ...
        if ($group_buy_id) {
            $Loaction = sanmu_url('/#/groupbuy/detail/' . $group_buy_id);
        } else {
            $Loaction = sanmu_url('/#/groupbuy');
        }
        ...
        elseif ($act == 'buy') {
            ...
            if ($goods_attr_id && $goods_info['cloud_id']) {
                ...
                if (is_callable($is_callable)) {
                    ...
                    $cloud_prod = sanmu_decode($cloud_prod, true);
            ...
            $url = $this->sanmuRepository->buildUri('group_buy', ['gbid' => $group_buy_id]);
            ...
            return sanmu_header("Location: ./flow.php?step=checkout&direct_shopping=5\n");
        }
