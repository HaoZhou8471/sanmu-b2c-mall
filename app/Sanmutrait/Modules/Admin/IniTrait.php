...
namespace App\Sanmutrait\Modules\Admin;
...
trait IniTrait
{
    ...
    protected function initialize()
    {
        ...
        defined('DATA_DIR') or define('DATA_DIR', $this->sanmu->data_dir());
        defined('IMAGE_DIR') or define('IMAGE_DIR', $this->sanmu->image_dir());
        ...
        if ($_REQUEST['act'] != 'login' && $_REQUEST['act'] != 'signin' &&
            ...
            $admin_path = preg_replace('/:\d+/', '', $this->sanmu->url()) . ADMIN_PATH;
