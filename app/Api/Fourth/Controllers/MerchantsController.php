...
class MerchantsController extends Controller
{
    ...
    public function agree(Request $request)
    {
        ...
        if (!empty($data['fid'])) {
            ...
            if (!empty($fields)) {
                $legal_person_fileImg_path = $this->sanmuRepository->editUploadImage($fields['legal_person_fileImg']);
                $license_fileImg_path = $this->sanmuRepository->editUploadImage($fields['license_fileImg']);
