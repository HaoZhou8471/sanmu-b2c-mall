...
class PresaleController extends Controller
{
    ...
    protected function initialize()
    {
        ...
        //加载语言包
        $this->sanmuRepository->helpersLang('presale');
    ...
    public function detail(Request $request)
    {
        ...
        if ($goods_img) {
            foreach ($goods_img as $key => $val) {
                $goods_img[$key]['img_url'] = $this->sanmuRepository->getImagePath($val['img_url']);
                $goods_img[$key]['img_original'] = $this->sanmuRepository->getImagePath($val['img_original']);
                $goods_img[$key]['thumb_url'] = $this->sanmuRepository->getImagePath($val['thumb_url']);
            }
        }
