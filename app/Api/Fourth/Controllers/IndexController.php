...
class IndexController extends Controller
{
    ...
    public function shopConfig()
    {
        ...
        $config['wap_logo'] = isset($config['wap_logo']) ? $this->sanmuRepository->getImagePath(str_replace('../', '', $config['wap_logo'])) : '';
        $config['shop_logo'] = isset($config['shop_logo']) ? $this->sanmuRepository->getImagePath(str_replace('../', '', $config['shop_logo'])) : '';
