...
class WholesaleApplyController extends Controller
{
    ...
    public function do_apply(Request $request)
    {
        ...
        if (!empty($suppliers)) {
            ...
            $front_of_id_card_path = $this->sanmuRepository->editUploadImage($suppliers['front_of_id_card']);
            $reverse_of_id_card_path = $this->sanmuRepository->editUploadImage($suppliers['reverse_of_id_card']);
            $suppliers_logo_path = $this->sanmuRepository->editUploadImage($suppliers['suppliers_logo']);
