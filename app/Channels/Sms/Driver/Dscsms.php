...
class Sanmusms
{
    ...
    {
        $app_key = isset($this->config['sanmu_appkey']) ? $this->config['sanmu_appkey'] : $this->config['app_key'];
        $app_secret = isset($this->config['sanmu_appsecret']) ? $this->config['sanmu_appsecret'] : $this->config['app_secret'];
