...
class SqlExecutor
{
     ...
     * @return  void
     */
    public function __construct($db, $charset = 'gbk', $sprefix = 'sanmu_', $tprefix = 'sanmu_', $log_path = '', $auto_match = false, $ignored_errors = [])
    {
     ...
     * @return  void
     */
    public function sql_executor($db, $charset = 'gbk', $sprefix = 'ecs_', $tprefix = 'ecs_', $log_path = '', $auto_match = false, $ignored_errors = [])
    {
        $this->db = $db;
