...
class UserBaitiaoService
{
    ...
    public function getBaitiaoLogInfo($other = [])
    {
        ...
        if ($other) {
            ...
            if ($row) {
                ...
                $row['format_stages_one_price'] = $this->sanmuRepository->getPriceFormat($row['stages_one_price'], false);
            }
        }
    ...
    public function getBaitiaoBalance($user_id = 0)
    {
        ...
        $arr['format_stay_pay'] = $this->sanmuRepository->getPriceFormat($total_amount, false);
        $arr['format_already_amount'] = $this->sanmuRepository->getPriceFormat($already_amount, false);
