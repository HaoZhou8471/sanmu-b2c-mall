    ...
    public function getGalleryList($where = [])
    {
        ...
        if ($img_list) {
            foreach ($img_list as $key => $val) {
                $img_list[$key]['thumb_url'] = $this->sanmuRepository->getImagePath($val['thumb_url']);
                $img_list[$key]['img_original'] = $this->sanmuRepository->getImagePath($val['img_original']);
                $img_list[$key]['img_url'] = $this->sanmuRepository->getImagePath($val['img_url']);
            }
        }
