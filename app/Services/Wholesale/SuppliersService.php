...
class SuppliersService
{
    ...
    public function suppliersInfo($user_id = 0)
    {
        ...
        if (!empty($result)) {
            ...
            $result['front_of_id_card'] = $this->sanmuRepository->getImagePath($result['front_of_id_card']);
            $result['reverse_of_id_card'] = $this->sanmuRepository->getImagePath($result['reverse_of_id_card']);
            $result['suppliers_logo'] = $this->sanmuRepository->getImagePath($result['suppliers_logo']);
        }
