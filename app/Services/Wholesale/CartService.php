                ...
                if ($goods_ids) {
                    foreach ($goods_ids as $a => $g) {
                        ...
                        if (isset($goods_data) && !empty($goods_data)) {
                            $goods_data['goods_thumb'] = isset($goods_data['goods_thumb']) && !empty($goods_data['goods_thumb']) ? $this->sanmuRepository->getImagePath($goods_data['goods_thumb']) : '';
                            ...
                            $goods_data['cart_goods_price_formatted'] = $this->sanmuRepository->getPriceFormat($goods_data['cart_goods_price']);
                            $goods_data['goods_price_formatted'] = isset($goods_data['goods_price']) && !empty($goods_data['goods_price']) ? $this->sanmuRepository->getPriceFormat($goods_data['goods_price']) : '';
                            $goods_data['total_price_formatted'] = $this->sanmuRepository->getPriceFormat($goods_data['total_price']);
                            ...
                            $goods_data['url'] = $this->sanmuRepository->buildUri('wholesale_goods', array('aid' => $goods_data['goods_id']), $goods_data['goods_name']); //链接地址
                        }
