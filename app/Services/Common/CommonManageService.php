...
class CommonManageService
{
    ...
    public function getSellerInfo()
    {
        ...
        /* 商家信息 */
        if ($seller_info) {
            $admin_user['admin_user_img'] = $this->sanmuRepository->getImagePath($admin_user['admin_user_img']);
            ...
            if ($seller_info['logo_thumb']) {
                ...
                $seller_info['logo_thumb'] = $this->sanmuRepository->getImagePath($seller_info['logo_thumb']);
            }
        }
