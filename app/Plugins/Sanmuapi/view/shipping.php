...
/* 初始化商品类 */
$shipping = new \App\Plugins\Sanmuapi\app\controller\shipping($val);
...
switch ($method) {
     ...
     * 插入快递方式信息
     */
    case 'sanmu.shipping.insert.post':
     ...
     * 更新快递方式信息
     */
    case 'sanmu.shipping.update.post':
