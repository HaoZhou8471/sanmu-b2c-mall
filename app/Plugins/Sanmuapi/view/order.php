...
/* 初始化商品类 */
$order = new \App\Plugins\Sanmuapi\app\controller\order($val);
...
switch ($method) {
     ...
     * 获取订单商品列表
     */
    case 'sanmu.order.goods.list.get':
     ...
     * 获取单条订单商品信息
     */
    case 'sanmu.order.goods.info.get':
     ...
     * 插入订单商品信息
     */
    case 'sanmu.order.goods.insert.post':
     ...
     * 更新订单商品信息
     */
    case 'sanmu.order.goods.update.post':
     ...
     * 删除订单商品信息
     */
    case 'sanmu.order.goods.del.get':
     ...
     * 订单发货
     */
    case 'sanmu.order.confirmorder.post':
