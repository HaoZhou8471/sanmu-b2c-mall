...
/* 初始化商品类 */
$product = new \App\Plugins\Sanmuapi\app\controller\product($val);
...
switch ($method) {
     ...
     * 插入商品货品信息
     */
    case 'sanmu.product.insert.post':
     ...
     * 更新商品货品信息
     */
    case 'sanmu.product.update.post':
     ...
     * 获取商品仓库货品列表
     */
    case 'sanmu.product.warehouse.list.get':
     ...
     * 获取单条商品仓库货品信息
     */
    case 'sanmu.product.warehouse.info.get':
     ...
     * 插入商品仓库货品信息
     */
    case 'sanmu.product.warehouse.insert.post':
     ...
     * 更新商品仓库货品信息
     */
    case 'sanmu.product.warehouse.update.post':
     ...
     * 删除商品仓库货品信息
     */
    case 'sanmu.product.warehouse.del.get':
     ...
     * 获取商品仓库货品列表
     */
    case 'sanmu.product.area.list.get':
     ...
     * 获取单条商品仓库货品信息
     */
    case 'sanmu.product.area.info.get':
     ...
     * 插入商品仓库货品信息
     */
    case 'sanmu.product.area.insert.post':
     ...
     * 更新商品仓库货品信息
     */
    case 'sanmu.product.area.update.post':
     ...
     * 删除商品仓库货品信息
     */
    case 'sanmu.product.area.del.get':
