...
/* 初始化商品类 */
$warehouse = new \App\Plugins\Sanmuapi\app\controller\warehouse($val);
...
switch ($method) {
     ...
     * 插入仓库地区信息
     */
    case 'sanmu.warehouse.insert.post':
     ...
     * 更新仓库地区信息
     */
    case 'sanmu.warehouse.update.post':
