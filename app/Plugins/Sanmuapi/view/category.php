...
/* 初始化商品类 */
$category = new \App\Plugins\Sanmuapi\app\controller\category($val);
...
switch ($method) {
     ...
     * 插入分类信息
     */
    case 'sanmu.category.insert.post':
     ...
     * 更新分类信息
     */
    case 'sanmu.category.update.post':
     ...
     * 获取商家分类列表
     */
    case 'sanmu.category.seller.list.get':
     ...
     * 获取单条商家分类信息
     */
    case 'sanmu.category.seller.info.get':
     ...
     * 插入商家分类信息
     */
    case 'sanmu.category.seller.insert.post':
     ...
     * 更新商家分类信息
     */
    case 'sanmu.category.seller.update.post':
     ...
     * 删除商家分类信息
     */
    case 'sanmu.category.seller.del.get':
