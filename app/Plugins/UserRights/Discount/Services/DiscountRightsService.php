...
class DiscountRightsService
{
    ...
    public function orderMembershipCardInfo($code = '', $user_id = 0, $cart_goods = [])
    {
            ...
            if (isset($discountRights['enable']) && isset($discountRights['install']) && $discountRights['enable'] == 1 && $discountRights['install'] == 1) {
                ...
                if ($rightsList) {
                    ...
                    if (!empty($membership_card)) {
                        ...
                        $membership_card_info['membership_card_buy_money_formated'] = $this->sanmuRepository->getPriceFormat($membership_card_buy_money);
        ...
        if ($discount > 0 && !empty($membership_card_info)) {
            ...
            $membership_card_info['membership_card_discount_price_formated'] = $this->sanmuRepository->getPriceFormat($membership_card_discount_price);
        }
    ...
    public function changeMembershipCard($order_membership_card_id = 0, $user_id = 0, $total = [])
    {
        ...
        $total['membership_card_buy_money_formated'] = empty($total['membership_card_buy_money']) ? null : $this->sanmuRepository->getPriceFormat($total['membership_card_buy_money']);
        $total['membership_card_discount_price_formated'] = $this->sanmuRepository->getPriceFormat($total['membership_card_discount_price']);
