        ...
        if ($_REQUEST['act'] == 'merchant_download') {
            ...
            if (!empty($merchants_download_content)) {
                foreach ($merchants_download_content as $k => $merchants_order_list) {
                    ...
                    $content .= sanmu_iconv(EC_CHARSET, 'GB2312', lang('suppliers/suppliers_commission.sum_price'));
                    $content .= sanmu_iconv(EC_CHARSET, 'GB2312', $valid['brokerage_amount']) . "\t\n";
                    $content .= sanmu_iconv(EC_CHARSET, 'GB2312', lang('suppliers/suppliers_commission.settled'));
                    $content .= sanmu_iconv(EC_CHARSET, 'GB2312', $valid['formated_is_settlement_amout']) . "\t\n";
                    $content .= sanmu_iconv(EC_CHARSET, 'GB2312', lang('suppliers/suppliers_commission.unsettled_accounts'));
                    $content .= sanmu_iconv(EC_CHARSET, 'GB2312', $valid['formated_no_settlement_amout']) . "\t\n";
                    $content .= sanmu_iconv(EC_CHARSET, 'GB2312', lang('suppliers/suppliers_commission.percent_value'));
                    $content .= sanmu_iconv(EC_CHARSET, 'GB2312', $valid['suppliers_percent'])."%" . "\t\n";
