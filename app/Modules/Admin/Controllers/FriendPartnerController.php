...
class FriendPartnerController extends InitController
{
    ...
    public function index()
    {
        ...
        elseif ($_REQUEST['act'] == 'insert') {
            ...
            $link_name = (!empty($_POST['link_name'])) ? $this->sanmuRepository->subStr(trim($_POST['link_name']), 250, false) : '';
            ...
            if ($res < 1) {
                ...
                $this->sanmuRepository->getOssAddFile([$link_logo]);
        ...
        elseif ($_REQUEST['act'] == 'edit') {
            ...
            $link_arr['link_name'] = $this->sanmuRepository->subStr($link_arr['link_name'], 250, false); // 截取字符串为250个字符避免出现非法字符的情况
        ...
        elseif ($_REQUEST['act'] == 'update') {
            ...
            $this->sanmuRepository->getOssAddFile([$linklogo_img]);
        ...
        elseif ($_REQUEST['act'] == 'delPic') {
            ...
            $this->sanmuRepository->getOssDelFile([$link_logo]);
