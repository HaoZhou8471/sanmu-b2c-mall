    ...
    private function order_warehouse_list($order_id)
    {
        ...
        if ($result === false) {
            ...
            $sql = "SELECT  og.warehouse_id, rw.region_name " .
                " FROM " . $this->sanmu->table('order_info') . " as oi" .

                " left join " . $this->sanmu->table('order_goods') . " as og on oi.order_id = og.order_id" .
                " left join " . $this->sanmu->table('region_warehouse') . " as rw on og. warehouse_id  = rw.region_id" .
            ...
            $sql = "SELECT  og.order_id, u.user_id, u.user_name, og.warehouse_id, rw.region_name, sum(og.attr_number) as attr_number" .
                ...
                " left join " . $this->sanmu->table('order_goods') . " as og on oi.order_id = og.order_id" .
                " left join " . $this->sanmu->table('region_warehouse') . " as rw on og. warehouse_id  = rw.region_id" .
                " left join " . $this->sanmu->table('users') . " as u on oi.user_id  = u.user_id" .
