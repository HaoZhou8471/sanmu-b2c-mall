    ...
    public function index()
    {
        ...
        elseif ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit') {
            ...
            if ($id) {
                ...
                $result['title_img'] = $this->sanmuRepository->getImagePath($result['title_img'] ?? '');
        ...
        elseif ($_REQUEST['act'] == 'insert') {
            ...
            if (!empty($_FILES['tit_img']['name'])) {
                ...
                $this->sanmuRepository->getOssAddFile([$title_img]);
            }
        ...
        elseif ($_REQUEST['act'] == 'update') {
            ...
            if (!empty($_FILES['tit_img']['name'])) {
                ...
                if ($zcproject && $zcproject['title_img']) {
                    sanmu_unlink(storage_public($zcproject['title_img']));
                    $this->sanmuRepository->getOssDelFile([$zcproject['title_img']]);
                }
            }
        ...
        elseif ($_REQUEST['act'] == 'del') {
            ...
            if ($count > 0) {
                ...
                if ($row && $row['title_img']) {
                    sanmu_unlink(storage_public($row['title_img']));
                    $this->sanmuRepository->getOssDelFile([$row['title_img']]);
                }
                ...
                if ($img && is_array($img)) {
                    ...
                    $this->sanmuRepository->getOssDelFile($img);
                }

                ZcProject::where('id', $id)->delete();

                return sanmu_header('Location:zc_project.php?act=list');
            }
        }
        ...
        elseif ($_REQUEST['act'] == 'product_list') {
            ...
            if ($result) {
                foreach ($result as $key => $val) {
                    $result[$key]['img'] = $this->sanmuRepository->getImagePath($val['img']);
                }
            }
        ...
        elseif ($_REQUEST['act'] == 'insert_product') {
            ...
            if (!empty($_FILES['product_img']['name'])) {
                ...
                $this->sanmuRepository->getOssAddFile([$product_img]);
            }
        ...
        elseif ($_REQUEST['act'] == 'update_product') {
            ...
            if ($product_img != '' && $row && $row['img']) {
                sanmu_unlink(storage_public($row['product_img']));
                $this->sanmuRepository->getOssDelFile([$row['product_img']]);
            }
        ...
        elseif ($_REQUEST['act'] == 'del_product') {
            ...
            if ($count > 0) {
                ...
                if ($row && $row['img']) {
                    sanmu_unlink(storage_public($row['img']));
                    $this->sanmuRepository->getOssDelFile([$row['img']]);
                }

                ZcGoods::where('id', $product_id)->delete();

                return sanmu_header('Location:zc_project.php?act=product_list&id=' . $id);
            }
        }
                ...
                foreach ($result as $k => $v) {
                    ...
                    if ($result[$k]['img']) {
                        foreach ($result[$k]['img'] as $img_key => $img_val) {
                            $result[$k]['img'][$img_key] = $this->sanmuRepository->getImagePath($img_val);
                        }
                    }
                }
            }
                ...
                if ($row) {
                    ...
                    if ($row['img']) {
                        foreach ($row['img'] as $key => $val) {
                            $row['img'][$key] = $this->sanmuRepository->getImagePath($val);
                        }
                    }
                }
        ...
        elseif ($_REQUEST['act'] == 'insert_evolve') {
            ...
            if ($evolve_img) {
                $this->sanmuRepository->getOssAddFile($evolve_img);
            }
        ...
        elseif ($_REQUEST['act'] == 'del_evolve') {
            ...
            return sanmu_header('Location:zc_project.php?act=progress&id=' . $id);
        }
        ...
        elseif ($_REQUEST['act'] == 'delete_image') {
            ...
            if ($type == 'project') {
                ...
                if ($img) {
                    ...
                    sanmu_unlink(storage_public($img_arr[$key]));

                    $this->sanmuRepository->getOssDelFile([$img_arr[$key]]);
