...
class CronController extends InitController
{
    ...
    public function index()
    {
        ...
        if ($act == 'list') {
            ...
            $modules = $this->sanmuRepository->readModules(plugin_path('Cron'));
            if ($modules) {
        ...
        elseif ($act == 'edit') {
            if (empty($_POST['step'])) {
                ...
                $this->sanmuRepository->helpersLang($_REQUEST['code'], 'Cron/' . Str::studly($_REQUEST['code']) . '/Languages/' . $GLOBALS['_CFG']['lang'], 1);
        ...
        elseif ($act == 'do') {
            ...
            $this->sanmuRepository->helpersLang($code, 'Cron/' . Str::studly($code) . '/Languages/' . $GLOBALS['_CFG']['lang'], 1);
