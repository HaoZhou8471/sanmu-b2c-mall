    ...
    public function index()
    {
        ...
        elseif ($_REQUEST['act'] == 'commission_amount') {
            ...
            if ($type == 'all') {
                ...
                $admin_all['gain_no_settlement'] = $this->sanmuRepository->getPriceFormat($admin_commission['gain_no_settlement']);
                $admin_all['gain_is_settlement'] = $this->sanmuRepository->getPriceFormat($admin_commission['gain_is_settlement']);
                $admin_all['is_settlement'] = $this->sanmuRepository->getPriceFormat($admin_commission['is_settlement']);
                $admin_all['no_settlement'] = $this->sanmuRepository->getPriceFormat($admin_commission['no_settlement']);
                $result['admin_all'] = $admin_all;
            }

            $admin_commission['gain_no_settlement'] = $this->sanmuRepository->getPriceFormat($admin_commission['gain_no_settlement']);
            $admin_commission['gain_is_settlement'] = $this->sanmuRepository->getPriceFormat($admin_commission['gain_is_settlement']);
            $admin_commission['is_settlement'] = $this->sanmuRepository->getPriceFormat($admin_commission['is_settlement'], false);
            $admin_commission['no_settlement'] = $this->sanmuRepository->getPriceFormat($admin_commission['no_settlement'], false);
        ...
        if ($_REQUEST['act'] == 'merchant_download') {
            ...
            if (!empty($merchants_download_content['orders'])) {
                foreach ($merchants_download_content['orders'] as $k => $merchants_order_list) {
                    ...
                    $content .= sanmu_iconv(EC_CHARSET, 'GB2312', $GLOBALS['_LANG']['commission_total']);
                    $content .= sanmu_iconv(EC_CHARSET, 'GB2312', $merchants_order_list['brokerage_amount']['all_price']) . "\t\n";
                    $content .= sanmu_iconv(EC_CHARSET, 'GB2312', $GLOBALS['_LANG']['is_settlement_amount']);
                    $content .= sanmu_iconv(EC_CHARSET, 'GB2312', $merchants_order_list['brokerage_amount']['is_settlement_price']) . "\t\n";
                    $content .= sanmu_iconv(EC_CHARSET, 'GB2312', $GLOBALS['_LANG']['no_settlement_amount']);
                    $content .= sanmu_iconv(EC_CHARSET, 'GB2312', $merchants_order_list['brokerage_amount']['no_settlement_price']) . "\t\n";
