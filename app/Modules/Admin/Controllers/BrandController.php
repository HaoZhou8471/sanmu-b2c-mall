...
class BrandController extends InitController
{
    ...
    public function index()
    {
        ...
        elseif ($_REQUEST['act'] == 'insert') {
            ...
            $this->sanmuRepository->getOssAddFile($brand_image);
        ...
        elseif ($_REQUEST['act'] == 'updata') {
            ...
            $this->sanmuRepository->getOssAddFile($add_oss_file);
        ...
        elseif ($_REQUEST['act'] == 'brand_separate_initial') {
            ...
            $brand_list = $this->sanmu->page_array($page_size, $page, $brand_list);
        ...
        elseif ($_REQUEST['act'] == 'create_brand_initial') {
            ...
            if ($result['list']) {
                ...
                if (!empty($result['list']['brand_first_char']) && in_array(strtoupper($result['list']['brand_first_char']), range('A', 'Z'))) {
                    ...
                    if ($this->sanmu->preg_is_letter($str_first)) {
                        $arr['brand_id'] = $result['list']['brand_id'];
                        $arr['brand_name'] = $result['list']['brand_name'];
                        $arr['brand_letter'] = $result['list']['brand_letter'];
        ...
        elseif ($_REQUEST['act'] == 'remove') {
            ...
            $this->sanmuRepository->getDelBatch('', $id, ['brand_logo'], 'brand_id', Brand::whereRaw(1), 0, DATA_DIR . '/brandlogo/'); //删除图片
        ...
        elseif ($_REQUEST['act'] == 'drop_logo') {
            ...
            $this->sanmuRepository->getDelBatch('', $brand_id, ['brand_logo'], 'brand_id', Brand::whereRaw(1), 0, DATA_DIR . '/brandlogo/'); //删除图片
