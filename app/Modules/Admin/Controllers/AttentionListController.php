            ...
            if ($count > $start) {
                ...
                if ($template) {
                    foreach ($query as $rt) {
                        ...
                        $preg_replace = $this->sanmu->url() . $this->sanmuRepository->buildUri('goods', ['gid' => $id], $rt['goods_name']);
            ...
            if ($count > $start) {
                ...
                if ($template) {
                    foreach ($query as $rt) {
                        ...
                        $preg_replace = $this->sanmu->url() . $this->sanmuRepository->buildUri('goods', ['gid' => $rt['goods_id']], $rt['user_name']);
