    ...
    public function index()
    {
        ...
        elseif ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit') {
            ...
            if (isset($_GET['id']) && !empty($_GET['id'])) {
                ...
                if ($result) {
                    $result['img'] = $this->sanmuRepository->getImagePath($result['img']);
                }
        ...
        elseif ($_REQUEST['act'] == 'del') {
            ...
            return sanmu_header('Location:zc_initiator.php?act=list');
        }
        ...
        elseif ($_REQUEST['act'] == 'del_rank_logo') {
            ...
            return sanmu_header('Location:zc_initiator.php?act=rank_logo');
        }
    }
}
