    ...
    public function index()
    {
        ...
        elseif ($_REQUEST['act'] == 'add') {
            ...
            if ($_POST['show_in_nav'] == 1) {
                ...
                //显示在自定义导航栏中
                $url = $this->sanmuRepository->buildUri('article_cat', ['acid' => $cat_id], $_POST['cat_name']);
                $other = [
                    'name' => $_POST['cat_name'],
                    'ctype' => 'a',
                    'cid' => $cat_id,
                    ...
                    if ($_POST['show_in_nav'] != $dat['show_in_nav']) {
                        if ($_POST['show_in_nav'] == 1) {
                            ...
                            if (empty($nid)) {
                                ...
                                $vieworder += 2;
                                $uri = $this->sanmuRepository->buildUri('article_cat', ['acid' => $cat_id], $cat_name);
            ...
            if ($res) {
                if ($val == 1) {
                    ...
                    if ($count > 0) {
                        ...
                        $uri = $this->sanmuRepository->buildUri('article_cat', ['acid' => $id], $catname);
