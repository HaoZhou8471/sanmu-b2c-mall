...
class OrderController extends InitController
{
    ...
    public function index()
    {
        ...
        elseif ($_REQUEST['act'] == 'info') {
            ...
            foreach ($res as $row) {
                ...
                $row['formated_goods_coupons'] = sprintf($GLOBALS['_LANG']['average_coupons'], $this->sanmuRepository->getPriceFormat($row['goods_coupons']));
        ...
        elseif ($_REQUEST['act'] == 'return_info') {
            ...
            if (isset($GLOBALS['_CFG']['show_mobile']) && $GLOBALS['_CFG']['show_mobile'] == 0) {
                $back_order['phone'] = $this->sanmuRepository->stringToStar($back_order['phone']);
            }
            ...
            if ($delivery_order['user_id'] > 0) {
                ...
                if (!empty($user_info)) {
                    ...
                    if (isset($GLOBALS['_CFG']['show_mobile']) && $GLOBALS['_CFG']['show_mobile'] == 0) {
                        ...
                        $delivery_order['mobile'] = $this->sanmuRepository->stringToStar($delivery_order['mobile']);
                    }
                }
            }
        ...
        elseif ($_REQUEST['act'] == 'back_info') {
            ...
            if ($back_order['user_id'] > 0) {
                ...
                if (!empty($user_info)) {
                    ...
                    if (isset($GLOBALS['_CFG']['show_mobile']) && $GLOBALS['_CFG']['show_mobile'] == 0) {
                        $back_order['user_name'] = $this->sanmuRepository->stringToStar($back_order['user_name']);
                        $back_order['mobile'] = $this->sanmuRepository->stringToStar($back_order['mobile']);
                    }
                }
            }
     ...
     */
        ...
        elseif ($_REQUEST['act'] == 'ajax_merge_order') {
            ...
            $from_order_sn = empty($_POST['from_order_sn']) ? [] : sanmu_decode($_POST['from_order_sn']);
        ...
        elseif ($_REQUEST['act'] == 'chang_order_list') {
            ...
            $order_list = $this->sanmu->page_array($page_size, $page, $order_list);
