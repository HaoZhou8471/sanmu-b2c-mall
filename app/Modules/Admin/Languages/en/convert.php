...
$_LANG = array(
    ...
    'dir_notes' => 'Note that the path to the root directory of the original mall is relative to the admin directory. <br /> for example: if the directory of the original mall is in the root directory of shop, and sanmumall is in the root directory, then the path is.. / shop',
