...
$_LANG['fields_next_null'] = '下一步标题不能为空';
...
$_LANG['operation_prompt_content']['info'][1] = '字段填写注意事项：';
$_LANG['operation_prompt_content']['info'][2] = '1、表单字段名称不可使用纯数字、数字+字母、同时不建议使用含大写字母。';
$_LANG['operation_prompt_content']['info'][3] = '2、表单字段名称建议使用纯字母（如tel，mobile_phone）。';
$_LANG['operation_prompt_content']['info'][4] = '3、选择类型是文件上传时（上传图片文件），表单字段名称后必须要加 _fileImg。例如：linked_bank_fileImg';
