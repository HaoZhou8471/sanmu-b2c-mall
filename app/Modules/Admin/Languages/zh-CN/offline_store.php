...
$_LANG['stores_name_sanmu'] = '请认真填写您的门店名称，以确保用户（购买者）线下到店自提时查找。';
$_LANG['area_info'] = '所在地区';
$_LANG['area_info_sanmu'] = '所在地区将直接影响购买者在选择线下自提时的地区筛选，因此请如实认真选择全部地区级。';
$_LANG['stores_address'] = '详细地址';
$_LANG['stores_address_sanmu'] = '请认真填写详细地址，以确保用户（购物者）线下到店自提时能最准确的到达您的门店。';
$_LANG['stores_tel'] = '联系方式';
$_LANG['stores_tel_sanmu'] = '请认真填写门店联系电话，方便用户（购物者）通过该电话与您直接取得联系。电话格式：4000-0000000';
$_LANG['stores_email'] = 'email';
$_LANG['stores_email_sanmu'] = '请认真填写门店email，方便密码找回。';
$_LANG['stores_opening_hours'] = '营业时间';
$_LANG['stores_opening_hours_sanmu'] = '如实填写您的线下门店营业时间，以免用户（购物者）在营业时间外到店产生误会。';
$_LANG['stores_traffic_line'] = '交通线路';
$_LANG['stores_traffic_line_sanmu'] = '如您的门店周围有公交、地铁线路到达，请填写该选项，多条线路请以“|”进行分隔。';
$_LANG['stores_img'] = '实景图片';
$_LANG['stores_img_sanmu'] = '将您的实体店面沿街图上传，方便用户（购物者）线下到店自提时能最准确直观的找到您的门店。';
$_LANG['is_confirm'] = '状态';
