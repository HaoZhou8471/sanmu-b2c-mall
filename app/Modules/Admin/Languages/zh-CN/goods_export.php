...
// 批量上传商品的字段
$_LANG['export_sanmumall'] = '导出到sanmumall数据格式';

$_LANG['sanmumall'] = [];
$_LANG['sanmumall']['goods_name'] = '商品名称';
$_LANG['sanmumall']['goods_sn'] = '商品货号';
$_LANG['sanmumall']['brand_name'] = '商品品牌';   // 需要转换成brand_id
$_LANG['sanmumall']['market_price'] = '市场售价';
$_LANG['sanmumall']['shop_price'] = '本店售价';
$_LANG['sanmumall']['integral'] = '积分购买额度';
$_LANG['sanmumall']['original_img'] = '商品原始图';
$_LANG['sanmumall']['goods_img'] = '商品图片';
$_LANG['sanmumall']['goods_thumb'] = '商品缩略图';
$_LANG['sanmumall']['keywords'] = '商品关键词';
$_LANG['sanmumall']['goods_brief'] = '简单描述';
$_LANG['sanmumall']['goods_desc'] = '详细描述';
$_LANG['sanmumall']['goods_weight'] = '商品重量（kg）';
$_LANG['sanmumall']['goods_number'] = '库存数量';
$_LANG['sanmumall']['warn_number'] = '库存警告数量';
$_LANG['sanmumall']['is_best'] = '是否精品';
$_LANG['sanmumall']['is_new'] = '是否新品';
$_LANG['sanmumall']['is_hot'] = '是否热销';
$_LANG['sanmumall']['is_on_sale'] = '是否上架';
$_LANG['sanmumall']['is_alone_sale'] = '能否作为普通商品销售';
$_LANG['sanmumall']['is_real'] = '是否实体商品';
