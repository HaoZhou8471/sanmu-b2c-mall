...
// 批量上傳商品的欄位
$_LANG['export_sanmumall'] = '導出到sanmumall數據格式';

$_LANG['sanmumall'] = [];
$_LANG['sanmumall']['goods_name'] = '商品名稱';
$_LANG['sanmumall']['goods_sn'] = '商品貨號';
$_LANG['sanmumall']['brand_name'] = '商品品牌';   // 需要轉換成brand_id
$_LANG['sanmumall']['market_price'] = '市場售價';
$_LANG['sanmumall']['shop_price'] = '本店售價';
$_LANG['sanmumall']['integral'] = '積分購買額度';
$_LANG['sanmumall']['original_img'] = '商品原始圖';
$_LANG['sanmumall']['goods_img'] = '商品圖片';
$_LANG['sanmumall']['goods_thumb'] = '商品縮略圖';
$_LANG['sanmumall']['keywords'] = '商品關鍵詞';
$_LANG['sanmumall']['goods_brief'] = '簡單描述';
$_LANG['sanmumall']['goods_desc'] = '詳細描述';
$_LANG['sanmumall']['goods_weight'] = '商品重量（kg）';
$_LANG['sanmumall']['goods_number'] = '庫存數量';
$_LANG['sanmumall']['warn_number'] = '庫存警告數量';
$_LANG['sanmumall']['is_best'] = '是否精品';
$_LANG['sanmumall']['is_new'] = '是否新品';
$_LANG['sanmumall']['is_hot'] = '是否熱銷';
$_LANG['sanmumall']['is_on_sale'] = '是否上架';
$_LANG['sanmumall']['is_alone_sale'] = '能否作為普通商品銷售';
$_LANG['sanmumall']['is_real'] = '是否實體商品';
