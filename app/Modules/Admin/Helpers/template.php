...
///* 插件的 library */
//$sql = 'SELECT code, library FROM ' . $this->sanmu->table('plugins') . " WHERE assign = 1 AND library > ''";
...
{
    $sql = 'SELECT code, library FROM ' . $GLOBALS['sanmu']->table('plugins') . " WHERE library > ''";
