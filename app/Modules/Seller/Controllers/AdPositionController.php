...
class AdPositionController extends InitController
{
    ...
    {
        $this->sanmuRepository->helpersLang('ads', 'seller');
        ...
        $exc = new Exchange($this->sanmu->table("ad_position"), $this->db, 'position_id', 'position_name');
        ...
        elseif ($act == 'remove') {
            ...
            /* 查询广告位下是否有广告存在 */
            $sql = "SELECT COUNT(*) FROM " . $this->sanmu->table('ad') . " WHERE position_id = '$id'";
