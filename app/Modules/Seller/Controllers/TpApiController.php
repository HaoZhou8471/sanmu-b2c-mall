...
class TpApiController extends InitController
{
    ...
    public function index()
    {
        ...
        elseif ($_REQUEST['act'] == 'order_print') {
            ...
            $sql = "SELECT value FROM " . $GLOBALS['sanmu']->table('shop_config') . " WHERE code = 'order_print_logo'";
            $order_print_logo = strstr($GLOBALS['db']->getOne($sql), "images");
            $this->smarty->assign('order_print_logo', $this->sanmu->seller_url() . SELLER_PATH . '/' . $order_print_logo);
