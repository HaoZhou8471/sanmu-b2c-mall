...
class GroupBuyController extends InitController
{
    ...
    public function index()
    {
        ...
        elseif ($_REQUEST['act'] == 'insert_update') {
            ...
            if (isset($_POST['finish'])) {
                ...
                /* 结束团购活动，修改结束时间为当前时间 */
                $sql = "UPDATE " . $this->sanmu->table('goods_activity') .
                    " SET end_time = '" . gmtime() . "' " .
                ...
                if ($group_buy_id > 0) {
                    ...
                    /* update */
                    $this->db->autoExecute($this->sanmu->table('goods_activity'), $group_buy, 'UPDATE', "act_id = '$group_buy_id' AND act_type = " . GAT_GROUP_BUY);
                    ...
                    /* insert */
                    $this->db->autoExecute($this->sanmu->table('goods_activity'), $group_buy, 'INSERT');
        ...
        elseif ($_REQUEST['act'] == 'batch_drop') {
            if (isset($_POST['checkboxes'])) {
                ...
                foreach ($_POST['checkboxes'] as $key => $id) {
                    ...
                    /* 删除团购活动 */
                    $sql = "DELETE FROM " . $this->sanmu->table('goods_activity') .
        ...
        elseif ($_REQUEST['act'] == 'edit_deposit') {
            ...
            $sql = "SELECT ext_info FROM " . $this->sanmu->table('goods_activity') .
        ...
        elseif ($_REQUEST['act'] == 'remove') {
            ...
            /* 删除团购活动 */
            $sql = "DELETE FROM " . $this->sanmu->table('goods_activity') . " WHERE act_id = '$id' LIMIT 1";
            $this->db->query($sql);
    ...
    {
        $sql = "SELECT * FROM " . $this->sanmu->table('goods_activity') .
