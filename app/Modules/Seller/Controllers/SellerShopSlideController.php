...
class SellerShopSlideController extends InitController
{
    ...
    public function index()
    {
        ...
        $exc = new Exchange($this->sanmu->table("seller_shopslide"), $this->db, 'id', 'img_url');
        ...
        elseif ($_REQUEST['act'] == 'add') {
            ...
            $sql = "INSERT INTO " . $this->sanmu->table('seller_shopslide') . "(img_url,img_link, img_desc, is_show, img_order, slide_type,ru_id, seller_theme) " .
        ...
        elseif ($_REQUEST['act'] == 'edit') {
            ...
            $sql = "SELECT * FROM " . $this->sanmu->table('seller_shopslide') . " WHERE id='$_REQUEST[id]' and ru_id='" . $adminru['ru_id'] . "'";
            ...
            if ($_FILES['img_url']['name']) {
                ...
                if ((isset($file['error']) && $file['error'] == 0) || (!isset($file['error']) && $file['tmp_name'] != 'none')) {
                    ...
                    if (!check_file_type($file['tmp_name'], $file['name'], $allow_file_types)) {
                        ...
                        /* 删除该幻灯片的图片*/
                        $sql = "SELECT img_url FROM " . $this->sanmu->table('seller_shopslide') . " WHERE id = '" . $_POST['id'] . "' LIMIT 1";
            ...
            if (!empty($oss_img_url)) {
                ...
                $this->sanmuRepository->getOssDelFile([$oss_img_url]);
            }
        ...
        elseif ($_REQUEST['act'] == 'remove') {
            ...
            /* 删除该幻灯片的图片*/
            $sql = "SELECT img_url FROM " . $this->sanmu->table('seller_shopslide') . " WHERE id = '$id'";
    ...
    {
        $adminru = get_admin_ru_id();
        $sql = "SELECT * FROM " . $this->sanmu->table('seller_shopslide') . " WHERE ru_id = '" . $adminru['ru_id'] . "' AND seller_theme = '$seller_theme'";
