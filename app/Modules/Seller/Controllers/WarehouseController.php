    ...
    public function index()
    {
        ...
        elseif ($_REQUEST['act'] == 'add_area') {
            ...
            if ($res > 0 && $regionId) {
                ...
                $sql = "select region_id from " . $this->sanmu->table('region_warehouse') . " where region_name = '$region_name' AND region_type <> 1";
                $res = $this->db->getOne($sql);
            ...
            $sql = "INSERT INTO " . $this->sanmu->table('region_warehouse') . " (regionId, parent_id, region_name, region_type) " .
        ...
        elseif ($_REQUEST['act'] == 'drop_area') {
            ...
            $sql = "DELETE FROM " . $this->sanmu->table("region_warehouse") . "WHERE region_id" . db_create_in($delete_region);
            $this->db->query($sql);
            if ($exc->drop($id)) {
        ...
        elseif ($_REQUEST['act'] == 'freight_insert') {
            ...
            $sql = "SELECT id FROM " . $this->sanmu->table('warehouse_freight') . " WHERE warehouse_id = '$warehouse_id' and shipping_id = '$shipping_id' and region_id = '$regionId'" . $ruCat;
