...
?> 
              <li class="fore <?php if (($this->_foreach['releated_goods_data']['iteration'] <= 1)): ?>fore1<?php endif; ?>" >
                <div class="p-img"><a target="_blank" rel="noopener noreferrer" title="<?php echo htmlspecialchars($this->_var['releated_goods_data']['goods_name']); ?>" href="<?php echo $this->_var['releated_goods_data']['url']; ?>"><img width="100" height="100" alt="" src="<?php echo $this->_var['releated_goods_data']['goods_thumb']; ?>" /></a> 
                </div>
                <div class="rate"><a target="_blank" rel="noopener noreferrer" title="<?php echo htmlspecialchars($this->_var['releated_goods_data']['goods_name']); ?>" href="<?php echo $this->_var['releated_goods_data']['url']; ?>"><?php echo $this->_var['releated_goods_data']['short_name']; ?></a></div>
