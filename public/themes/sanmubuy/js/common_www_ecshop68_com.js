...
function addProductsToCart(goodsId)
{
  ...
  else
  {
    ...
    else
    {
         ...
         $.ajax({
          type:"POST",
          url:"flow.php?step=add_products_to_cart",
          dataType:"JSON",     //接受数据格式
          data:"buy_str="+d+"&goods_id="+goodsId,
          success:addProductsToCartResponse
        })  
    }
  }
}
    ...
    else
    {
      //alert('act=update_price&id=' + goodsId + '&buy_str=' + d);
        ...
        $.ajax({
          ...
          url:'goods.php',
          dataType:'JSON',     //接受数据格式
          data:'act=update_price&id=' + goodsId + '&buy_str=' + d,
          success:updateSumPriceResponse
        });  
    }
  }
}
...
function addPackageToCart(packageId)
{
  ...
  package_info.number     = number;
          ...
          dataType:'JSON',     //接受数据格式
          data:'package_info=' + package_info.toJSONString(),
